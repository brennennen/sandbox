 ...
 */
emu_result_t emu_move(emulator_8086_t* emulator, uint8_t byte1) {
    direction_t direction = 0;
    wide_t wide = 0;
    mod_t mode = 0;
    uint8_t reg = 0;
...
static void write_move_immediate_to_register(
    wide_t wide,
    uint8_t reg,
    uint16_t immediate,
    char* buffer,
