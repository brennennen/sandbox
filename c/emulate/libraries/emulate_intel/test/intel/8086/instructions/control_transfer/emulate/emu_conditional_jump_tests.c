...
Test(emulate__conditional_jump__tests, jnz2, .init = emulate_conditional_jump_default_setup) {
    ...
    // sub cx, 1
    // jnz loop_start
    uint8_t input[] = {0xb9, 0x03, 0x00, 0xbb, 0xe8, 0x03, 0x83,
                       0xc3, 0x0a, 0x83, 0xe9, 0x01, 0x75, 0xf8};
    cr_assert(SUCCESS == emu_8086_emulate_chunk(&g_emulator, input, sizeof(input)));
...
Test(emulate__conditional_jump__tests, jnz3, .init = emulate_conditional_jump_default_setup) {
    ...
    //     cmp si, dx
    //     jnz init_loop_start
    uint8_t input[] = {0xba, 0x06, 0x00, 0xbe, 0x00, 0x00, 0x83,
                       0xc6, 0x02, 0x39, 0xd6, 0x75, 0xf9};
    cr_assert(SUCCESS == emu_8086_emulate_chunk(&g_emulator, input, sizeof(input)));
...
Test(emulate__conditional_jump__tests, jnz4, .init = emulate_conditional_jump_default_setup) {
    ...
    //     cmp si, dx
    //     jnz init_loop_start
    uint8_t input[] = {0xba, 0x06, 0x00, 0xbd, 0xe8, 0x03, 0xbe, 0x00, 0x00,
...
Test(emulate__conditional_jump__tests, jnz5, .init = emulate_conditional_jump_default_setup) {
    ...
    //     cmp si, dx
    //     jnz add_loop_start
    uint8_t input[] = {0xba, 0x06, 0x00, 0xbd, 0xe8, 0x03, 0xbe, 0x00, 0x00, 0x89, 0x32, 0x83,
