...
mov sp, di\n\
mov bp, ax\n";
    uint8_t input[] = {0x89, 0xd9, 0x88, 0xe5, 0x89, 0xda, 0x89, 0xde, 0x89, 0xfb, 0x88,
...
Test(decode__I_MOVE_IMMEDIATE_TO_REGISTER__tests, mov2, .init = decode_mov_default_setup) {
    char* expected = "mov ch, 244\n";  // mov cl, -12 ; cpu doesn't care about signedness until you
...
mov [bp + si], cl\n\
mov [bp], ch\n";
    uint8_t input[] = {0x89, 0xde, 0x88, 0xc6, 0xb1, 0x0c, 0xb5, 0xf4, 0xb9, 0x0c, 0x00,
