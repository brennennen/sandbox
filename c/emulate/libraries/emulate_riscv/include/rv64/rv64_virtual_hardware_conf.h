 ...
 * @see 30.2 Implementation-defined Constant Parameters
 * (https://riscv.github.io/riscv-isa-manual/snapshot/unprivileged/#_implementation_defined_constant_parameters)
 */
#define ELEN 64
