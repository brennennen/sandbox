...
Test(emu_rv64_decode_tag_tests, decode_instruction_tests) {
    ...
    // RV64I Zicsr
    cr_assert(
        I_RV64ZICSR_CSRRW == rv64_decode_instruction_tag(0x340292f3)
    );  // csrrw t0, mscratch, t0
    cr_assert(
        I_RV64ZICSR_CSRRS == rv64_decode_instruction_tag(0x300322f3)
    );  // csrrs t0, mstatus, t1
    cr_assert(
        I_RV64ZICSR_CSRRC == rv64_decode_instruction_tag(0x300332f3)
    );  // csrrc t0, mstatus, t1
    cr_assert(
        I_RV64ZICSR_CSRRWI == rv64_decode_instruction_tag(0x3407d2f3)
    );  // csrrwi t0, mscratch, 15
    cr_assert(
        I_RV64ZICSR_CSRRSI == rv64_decode_instruction_tag(0x3007e2f3)
    );  // csrrsi t0, mstatus, 15
    cr_assert(
        I_RV64ZICSR_CSRRCI == rv64_decode_instruction_tag(0x3007f2f3)
    );  // csrrci t0, mstatus, 15
    ...
    cr_assert(
        I_RV64ZAAMO_AMOSWAP_W == rv64_decode_instruction_tag(0x0805202f)
    );  // amoswap.w t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOADD_W == rv64_decode_instruction_tag(0x0063a2af)
    );  // amoadd.w t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOXOR_W == rv64_decode_instruction_tag(0x2063a2af)
    );  // amoxor.w t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOAND_W == rv64_decode_instruction_tag(0x6063a2af)
    );  // amoand.w t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOOR_W == rv64_decode_instruction_tag(0x4063a2af)
    );  // amoor.w t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOMIN_W == rv64_decode_instruction_tag(0x8063a2af)
    );  // amomin.w t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOMAX_W == rv64_decode_instruction_tag(0xa063a2af)
    );  // amomax.w t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOMINU_W == rv64_decode_instruction_tag(0xc063a2af)
    );  // amominu.w t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOMAXU_W == rv64_decode_instruction_tag(0xe063a2af)
    );  // amomaxu.w t0, t1, (t2)
    ...
    cr_assert(
        I_RV64ZAAMO_AMOSWAP_D == rv64_decode_instruction_tag(0x0863b2af)
    );  // amoswap.d t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOADD_D == rv64_decode_instruction_tag(0x0063b2af)
    );  // amoadd.d t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOXOR_D == rv64_decode_instruction_tag(0x2063b2af)
    );  // amoxor.d t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOAND_D == rv64_decode_instruction_tag(0x6063b2af)
    );  // amoand.d t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOOR_D == rv64_decode_instruction_tag(0x4063b2af)
    );  // amoor.d t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOMIN_D == rv64_decode_instruction_tag(0x8063b2af)
    );  // amomin.d t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOMAX_D == rv64_decode_instruction_tag(0xa063b2af)
    );  // amomax.d t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOMINU_D == rv64_decode_instruction_tag(0xc063b2af)
    );  // amominu.d t0, t1, (t2)
    cr_assert(
        I_RV64ZAAMO_AMOMAXU_D == rv64_decode_instruction_tag(0xe063b2af)
    );  // amomaxu.d t0, t1, (t2)
    ...
    cr_assert(
        I_RV64F_FMADD_S == rv64_decode_instruction_tag(0x60b57543)
    );  // fmadd.s fa0, fa0, fa1, fa2
    cr_assert(
        I_RV64F_FMSUB_S == rv64_decode_instruction_tag(0x60b57547)
    );  // fmsub.s fa0, fa0, fa1, fa2
    cr_assert(
        I_RV64F_FNMSUB_S == rv64_decode_instruction_tag(0x60b5754b)
    );  // fnmsub.s fa0, fa0, fa1, fa2
    cr_assert(
        I_RV64F_FNMADD_S == rv64_decode_instruction_tag(0x60b5754f)
    ...
    cr_assert(
        I_RV64F_FSGNJN_S == rv64_decode_instruction_tag(0x20b51553)
    );  // fsgnjn.s fa0, fa0, fa1
    cr_assert(
        I_RV64F_FSGNJX_S == rv64_decode_instruction_tag(0x20b52553)
    ...
    cr_assert(
        I_RV64V_VSETVLI == rv64_decode_instruction_tag(0x0d06f757)
    );  // vsetvli a4, a3, e32, m1, ta, ma
    cr_assert(
        I_RV64V_VSETIVLI == rv64_decode_instruction_tag(0xc804f2d7)
