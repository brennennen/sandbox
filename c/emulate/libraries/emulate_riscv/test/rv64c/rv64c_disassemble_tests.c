...
// MARK: c.addi tests
Test(emu_rv64c_disassemble__I_RV64C_CADDI__tests, caddi_1, .init = rv64c_disassemble_default_setup)
{
...
// MARK: c.addiw tests
Test(emu_rv64c_disassemble__I_RV64C_CADDIW__tests, caddiw_1, .init = rv64c_disassemble_default_setup)
{
...
// MARK: c.slli tests
Test(emu_rv64c_disassemble__I_RV64C_CSLLI__tests, cslli_1, .init = rv64c_disassemble_default_setup)
{
...
// MARK: c.srli tests
Test(emu_rv64c_disassemble__I_RV64C_CSRLI__tests, csrli_1, .init = rv64c_disassemble_default_setup)
{
...
// MARK: c.srai tests
Test(emu_rv64c_disassemble__I_RV64C_CSRAI__tests, csrai_1, .init = rv64c_disassemble_default_setup)
{
...
// MARK: c.andi tests
Test(emu_rv64c_disassemble__I_RV64C_CANDI__tests, candi_1, .init = rv64c_disassemble_default_setup)
{
...
// Test(emu_rv64c_disassemble__I_RV64C_CADDW__tests, caddw_1, .init = rv64c_disassemble_default_setup)
// {
...
// MARK: c.subw tests
// TODO: 'addw fp, fp, s1', 'fp' instead of 's0'
// Test(emu_rv64c_disassemble__I_RV64C_CSUBW__tests, csubw_1, .init = rv64c_disassemble_default_setup)
// {
