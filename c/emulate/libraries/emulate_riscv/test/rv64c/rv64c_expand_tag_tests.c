...
Test(emu_rv64c_expand_tag_tests, expand_instruction_tests) {
    ...
    cr_assert(
        I_RV64I_ADDI == rv64_decode_instruction_tag(rv64c_expand(0x0341))
    );  // addi t1, t1, 16
    cr_assert(
        I_RV64I_ADDIW == rv64_decode_instruction_tag(rv64c_expand(0x2341))
    );  // addiw t1, t1, 16
    // cr_assert(I_RV64I_ADDI == rv64_decode_instruction_tag(rv64c_expand(0x1101))); // addi sp, sp,
    // -32 # addi16sp cr_assert(I_RV64I_ADDI == rv64_decode_instruction_tag(rv64c_expand(0x0068)));
    // // addi a0, sp, 12 # addi4spn
    ...
    cr_assert(
        I_RV64I_ANDI == rv64_decode_instruction_tag(rv64c_expand(0x893d))
    );                                                                            // andi a0, a0, 15
    ...
    cr_assert(
        I_RV64I_ADDW == rv64_decode_instruction_tag(rv64c_expand(0x9c25))
    );  // addw s0, s0, s1
    cr_assert(
        I_RV64I_SUBW == rv64_decode_instruction_tag(rv64c_expand(0x9c05))
    );  // subw s0, s0, s1
    // TODO - 0
    // TODO - C.NOP
    ...
    cr_assert(
        I_RV64I_LW == rv64_decode_instruction_tag(rv64c_expand(0x4532))
    );  // lw a0, 12(sp) # lwsp
    cr_assert(
        I_RV64I_LD == rv64_decode_instruction_tag(rv64c_expand(0x64c2))
    );  // ld s1, 16(sp) # ldsp
    // TODO - FLDSP (rv64d - not implemented yet)
    cr_assert(I_RV64I_JALR == rv64_decode_instruction_tag(rv64c_expand(0x8082)));  // jr ra # c.jr
    cr_assert(
        I_RV64I_ADD == rv64_decode_instruction_tag(rv64c_expand(0x852e))
    );  // c.mv a0, a1 # c.mv
    ...
    cr_assert(
        I_RV64I_SW == rv64_decode_instruction_tag(rv64c_expand(0xc62a))
    );  // sw a0, 12(sp) # swsp
    // TODO - FSDSP (rv64d - not implemented yet)
    cr_assert(
        I_RV64I_SD == rv64_decode_instruction_tag(rv64c_expand(0xe826))
    );  // sd s1, 16(sp) # sdsp
}
