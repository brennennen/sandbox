...
void rv64_emu_bgeu_default_setup(void) {
    memset(&g_emulator, 0, sizeof(emulator_rv64_t));
    emu_rv64_init(&g_emulator);
}

Test(emu_rv64_emulate__bgeu__tests, bgeu_take_branch, .init = rv64_emu_bgeu_default_setup)
{
    uint8_t input[] = {
        0x13, 0x03, 0x40, 0x01, // li t1, 20
        0x93, 0x03, 0xa0, 0x00, // li t2, 10
        0x63, 0x74, 0x73, 0x00, // bgeu t1, t2, next
