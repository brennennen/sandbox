...
{
    g_emulator.registers.regs[RV64_REG_T1] = 0b1001;
    g_emulator.control_status_registers.float_csrs.fflags = 0b1101;
    ...
    cr_assert(0b1101 == g_emulator.registers.regs[RV64_REG_T0]);
    cr_assert(0b0100 == g_emulator.control_status_registers.float_csrs.fflags);
}
