...
{
    g_emulator.registers.regs[RV64_REG_T1] = 0b0110;
    g_emulator.control_status_registers.float_csrs.fflags = 0b1001;
    ...
    cr_assert(0b1001 == g_emulator.registers.regs[RV64_REG_T0]);
    printf("csrrs: %ld\n", g_emulator.control_status_registers.float_csrs.fflags);
    cr_assert(0b1111 == g_emulator.control_status_registers.float_csrs.fflags);
}
