 ...
 */
static const char* log_level_names[] = {"INFO ", "WARN ", "ERROR"};
 ...
 * Example output:
 * `[2025-04-21T01:00:56][DEBUG][emu_next] hit 0x00, assuming this is end of program. ip:
 * 258`
 */
 ...
 * When to use: In each emulated instruction to provide a trace of what instructions were
 * executed.
