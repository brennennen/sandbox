...
instruction_tag_t dcd_decode_tag(uint8_t byte1, uint8_t byte2) {
    switch(byte1) {
        ...
        // MARK: PUSH
        // PUSH 1 - I_PUSH_REGISTER_OR_MEMORY - handled by "COMMON 0b11111111"
        // PUSH 2 - 0b01010xxx
        case 0b01010000:
        case 0b01010001:
        case 0b01010010:
        ...
        // MARK: POP
        // POP 1 - I_POP_REGISTER_OR_MEMORY - handled by "COMMON 0b11111111"
        // POP 2 - 0b01011xxx
        case 0b01011000:
        case 0b01011001:
        case 0b01011010:
        ...
        case 0b10000011: {
            ...
            switch(sub_opcode) {
                ...
                // AND 2
                case 0b00100000:
                    return I_AND_IMMEDIATE_TO_REGISTER_OR_MEMORY;
                // OR 2
                case 0b00001000:
        ...
        // ADC 2 - I_ADC_IMMEDIATE_TO_REGISTER_OR_MEMORY - handled by "COMMON 0b100000xx"
        // ADC 3 - 0b0001010x
        case 0b00010100:
        case 0b00010101:
        ...
        // SBB 2 - I_SBB_IMMEDIATE_FROM_REGISTER_OR_MEMORY - handled by common "COMMON 0b100000xx"
        // SBB 3 - 0b0010110x
        case 0b00011100:
        case 0b00011101:
        ...
        // MARK: AND
        // AND 1 - I_AND_REGISTER_OR_MEMORY_WITH_REGISTER_TO_EITHER - 0b0010000xx
        case 0b00100000:
        case 0b00100001:
        case 0b00100010:
        case 0b00100011:
            return I_AND_REGISTER_OR_MEMORY_WITH_REGISTER_TO_EITHER;
        // AND 2 - I_AND_IMMEDIATE_TO_REGISTER_OR_MEMORY - handled by common
        // AND 3 - I_AND_IMMEDIATE_TO_ACCUMULATOR - 0b0010010x
        case 0b00100100:
        case 0b00100101:
            return I_AND_IMMEDIATE_TO_ACCUMULATOR;
