...
// MARK: ADD
Test(dcd_decode_tag_tests, I_ADD_REGISTER_OR_MEMORY_WITH_REGISTER_TO_EITHER) {
    instruction_tag_t output_tag = dcd_decode_tag(0b00000000, 0);
    cr_assert(I_ADD_REGISTER_OR_MEMORY_WITH_REGISTER_TO_EITHER == output_tag, 
        "Expected I_ADD_REGISTER_OR_MEMORY_WITH_REGISTER_TO_EITHER opcode, got: %d", output_tag);
}

Test(dcd_decode_tag_tests, I_ADD_IMMEDIATE_TO_REGISTER_OR_MEMORY) {
    instruction_tag_t output_tag = dcd_decode_tag(0b10000000, 0b00000000);
    cr_assert(I_ADD_IMMEDIATE_TO_REGISTER_OR_MEMORY == output_tag, 
        "Expected I_ADD_IMMEDIATE_TO_REGISTER_OR_MEMORY opcode, got: %d", output_tag);
}

Test(dcd_decode_tag_tests, I_ADD_IMMEDIATE_TO_ACCUMULATOR) {
    instruction_tag_t output_tag = dcd_decode_tag(0b00000100, 0);
    cr_assert(I_ADD_IMMEDIATE_TO_ACCUMULATOR == output_tag, 
        "Expected I_ADD_IMMEDIATE_TO_ACCUMULATOR opcode, got: %d", output_tag);
}
