/**
 * An example of a system with 3 workers and 3 shared resources, each worker needing 2
 * specific shared resources and a naive concurrency implementation that causes a deadlock
 * using mutexes with blocking aquires.
 *
 * * Scenario:
 ...
 *   * All workers are stuck waiting on a resource, the system is in a deadlock because of
 * a "circular wait".
 */
