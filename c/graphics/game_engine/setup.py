...
def download_stb_image():
    ...
    stb_image_write = "https://raw.githubusercontent.com/nothings/stb/refs/heads/master/stb_image_write.h"
    ...
    urllib.request.urlretrieve(stb_image_write, os.path.join(stb_dir, "stb_image_write.h"))
...
def download_bc7enc():
    bc7_dir = os.path.join(VENDOR_DIR, "bc7")
    if os.path.exists(bc7_dir):
        return
