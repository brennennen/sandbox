...
def build_consumer_from_latest_offset(topic_name, partition=0):
    """! Builds a consumer pointing at the most recent message in the queue. """
...
def consume_to_console(consumer):
    """! Reads every message from a topic and outputs it to stdout. """
...
if __name__ == "__main__":
    ...
    #consumer = build_consumer_from_latest_offset("test_topic", 0)
    #consume_to_console(consumer)